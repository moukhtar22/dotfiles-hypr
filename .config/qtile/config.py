...
def autostart_once():
    subprocess.run('/home/dilan/.config/qtile/autostart.sh')
...
keys = [
    ...
    Key([mod, "shift"], "q", lazy.spawn("wlogout")),
    ...
    Key([mod], "F12", lazy.spawn("playerctl next")),
    Key([mod], "F11", lazy.spawn("playerctl play-pause")),
    Key([mod], "F10", lazy.spawn("playerctl previous")),
